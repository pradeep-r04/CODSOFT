...
class todo:
    def __init__(self, root):
        ...
        self.label = Label(self.root, text='To-Do-List-App',
                font='Times, 26 bold', width=10,bd=5, bg='aqua', fg='black')
        self.label.pack(side='top', fill=BOTH)

        self.label2=Label(self.root, text='Add Task',
                font='Helvetica, 20 bold', width=10,bd=5, bg='gold', fg='black')
        self.label2.place(x=50, y=55)

        self.label3 = Label(self.root, text='Tasks',
                            font='Times, 20 bold', width=10, bd=5, bg='gold', fg='black')
        self.label3.place(x=350, y=55)
        ...
        self.button = Button(self.root, text='Add', font='serif, 20 bold italic',
                             width=10, bd=5, bg='springgreen', fg='black', command=add)
        self.button.place(x=30, y=180)

        self.button2 = Button(self.root, text='Delete', font='serif, 20 bold italic',
                             width=10, bd=5, bg='springgreen', fg='black', command=delete)
